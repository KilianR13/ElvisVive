...
namespace VicGenLib
{
    namespace Calc
    {
        ...
        {       
            ...
            public static UnityEngine.Vector3 SimplerLerp(GameObject objeto, GameObject startPoint, GameObject endPoint, float lerpTime, float timeElapsed, out float timeElapsedOutPut)
            {

                float t = timeElapsed / lerpTime / 30;

                t = Mathf.Clamp01(t);

                objeto.transform.position = UnityEngine.Vector3.Lerp(startPoint.transform.position, endPoint.transform.position, t);
            ...
            public static UnityEngine.Vector3 SimplerLerp(GameObject objeto, Transform startPoint, Transform endPoint, float lerpTime, float timeElapsed, out float timeElapsedOutPut)
            {
                ...
                objeto.transform.position = UnityEngine.Vector3.Lerp(startPoint.position, endPoint.position, t);
            ...
            public static UnityEngine.Vector3 SimplerLerp(GameObject objeto, Vector3 startPoint, Vector3 endPoint, float lerpTime, float timeElapsed, out float timeElapsedOutPut)
            {
                ...
                objeto.transform.position = UnityEngine.Vector3.Lerp(startPoint, endPoint, t);
